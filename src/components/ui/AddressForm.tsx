...
//   initialAddress?: any; // Add this
// }

// const AddressForm: React.FC<AddressFormProps> = ({ addressType, onSave, initialAddress }) => {
//   // Initialize state based on initialAddress, or default to empty values
...
//   // Update the state when initialAddress changes
//   useEffect(() => {
//     if (initialAddress) {
//       setAddressFields({
...
//   const handleSave = () => {
//     onSave({ ...addressFields, type: addressType });
//   };
...
//         </div>
//       ))}
//       <button onClick={handleSave} className="bg-blue-500 text-white py-2 px-4 rounded">Save Address</button>
//     </div>
//   );
// };
